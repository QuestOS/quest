...
/* Modified to work on Quest, original copyright is below */
...
#ifdef USE_PRINTF  
# define PRINT_MSG(fmt, ...) DLOG_PREFIX("tlsf",fmt,##__VA_ARGS__)
# define ERROR_MSG(fmt, ...) DLOG_PREFIX("tlsf",fmt,##__VA_ARGS__)
#else
