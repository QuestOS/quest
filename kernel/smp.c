...
volatile bool mp_num_cpus = 1;
volatile bool mp_apic_mode = 0;
volatile bool mp_ISA_PC = 0;
 ...
 * qemu fails. */
uint32
boot_cpu (uint8 apic_id, uint8 APIC_version)
{
  int success = 1;
  volatile int to;
